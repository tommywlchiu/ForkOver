...
- A charge labeled as a service charge ("Service Charge", "Svc Chg", 服務費) or gratuity is automatic gratuity. Automatic gratuity and any printed or handwritten tip go in printedTipCents with the matching tipSource. Other surcharges and fees (service fee, administration fee, kitchen surcharge, cover or table charge such as チャージ料, card surcharge) go in fees.
